...
<p>
  ...
  <ul>
    <li>Dispositivo 1 (Home edition):</li>
      ...
      <div style="display: flex;">
        <img src="./Images/First_project/Home_edition.jpg" alt="First device"  style="width: 100px; margin: 20px"/>
        <img src="./Images/First_project/PCB.png" alt="PCB first device" style="width: 100px; margin: 20px"/>
      </div>
